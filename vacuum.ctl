; This code calculate the time decay function of an electric dipole placed in vacuum.
; The dipole source frequency is at the D1 line of Cs atoms and have the same property
; as the ones used in other waveguide simulations. Results will be used with the
; waveguide simulations to calculate local Green's function tensor in presence of a
; dielectric waveguide. For this program, a computational area is chosen to be the 
; same as the square waveguide case. 
; By Xiaodong Qi (i2000s@hotmail.com), 2017-04-21.
...
(set! geometry
	(list
		; Build all space as vacuum.
		(make block (center 0 0 0) (size infinity infinity infinity) (material mcl))
	)
)
